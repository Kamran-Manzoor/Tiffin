...
public class Supplier_Account extends AppCompatActivity {
    ...
    TextView tvEmail,tvContact,tvLocation,tvPassword;
...
//        });
    ...
    private void initViewUser() {
        tvEmail=findViewById( R.id.tv_email_userprofile);
        tvContact=findViewById( R.id.tv_contact_no__userprofile);
        tvLocation = findViewById(R.id.tv_location_userprofile);
        tvPassword=findViewById(R.id.tv_password_userprofile);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()){
             case R.id.menu_edit:
                 ...
                 imm.showSoftInput(tvContact, InputMethodManager.SHOW_IMPLICIT);
             ...
             case R.id.menu_save:
                 ...
                 tvContact.setFocusableInTouchMode(false);
